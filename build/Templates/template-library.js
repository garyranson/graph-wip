...
const cache = new Map();
const defaultTemplate = new node_template_1.default("<g class='gpobject' data-gp='core' data-position-bind=''>" +
    ...
    "  </foreignObject>" +
    "</g>");
const rootTemplate = new node_template_1.default("<svg data-size-bind='0'>" +
    "</svg>");
const outline = new node_template_1.default("<g data-position-bind='0'>" +
