...
const cache = new Map();
const defaultTemplate = new node_template_1.default("<g class='gpobject' data-gp='mover' data-position-bind=''>" +
    ...
    */
    "</g>");
const rootTemplate = new node_template_1.default(`<svg data-gp='canvas' width='100%' height='100%' style='pointer-events: all;background-color: yellow'>` +
    `</svg>`);
const nodeSelect = new node_template_1.default(`<g data-position-bind='0' class='gp-node-highlight'>` +
    ...
    `</g>`);
const nodeHighlight = new node_template_1.default(`<g>` +
    `<rect data-position-bind='0' data-border-bind='0' class='dragOutline'></rect>` +
    `</g>`);
const nodeResize = new node_template_1.default(`<g data-position-bind='0'>` +
    ...
    `</g>`);
const nodeDrag = new node_template_1.default(`<g data-position-bind='0'>` +
    `<rect  data-border-bind='0' class='dragOutline'></rect>` +
    `<text dy="1em" text-anchor="middle" data-xy-ratio='0.5 1 0 0' data-text-template='point' font-family="Verdana" font-size="12"></text>` +
    `</g>`);
const nodeSelectorBand = new node_template_1.default(`<g data-position-bind='0'>` +
